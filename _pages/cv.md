...
You can find my CV [here](https://mushahid-intesum.github.io/files/My_CV.pdf)
...
* Bird Call Identifier Using ESP32
  * A bird call identifier deployed on ESP32 MCU with on-device inference. Using the BirdClef dataset, the model was trained, quantized and deployed on the ESP32. Utilized hierarchical labels and class balanced sampling
